 ...
 *   3. Pad with gray (114) to fill 320ÁE20
 *   4. RGB channel order (model trained on RGB input)
 *   5. Quantize to int8: int8_val = pixel_value + (-128) = pixel_value - 128
 *      (input scale=0.00392157 ≁E1/255, zero_point=-128)
 *
 * Output layout: HWC  [320 ÁE320 ÁE3]  int8
 ******************************************************************************
 */
 ...
 *                                 Must hold at least (dest_w ÁEdest_h ÁE3) bytes.
...
#endif /* YOLO_FASTEST_PREPROCESSING_H */
