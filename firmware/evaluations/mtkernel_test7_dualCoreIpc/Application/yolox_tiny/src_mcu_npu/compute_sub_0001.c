...
void compute_sub_0001(
  ...
  int8_t model_17_tf_strided_slice_10_StridedSlice_70183[37632] , // 1,112,112,3
  
  int8_t model_17_tf_strided_slice_11_StridedSlice_70184[37632]  // 1,112,112,3
  
) {
  // Buffers allocated on the main storage (note: depends on the execution order)
    
  
  int8_t* model_17_tf_strided_slice_7_StridedSlice_70182 = (int8_t *) &main_storage[0]; // 1,112,224,3 == 75264
  ...
  static const int32_t Int32VecConstant_70000_1[4] = { // 4
    1, 2, 1, 1, 
  };
  
  static const int32_t Int32VecConstant_70001_1[4] = { // 4
    0, 224, 0, 0, 
  };
  ...
  static const int32_t Int32VecConstant_70003[4] = { // 4
    0, 1, 0, 0, 
  };
...
StridedSlice(serving_default_images_0,  // input data
  model_17_tf_strided_slice_7_StridedSlice_70182,      // output data
  Int32VecConstant_70003,       // begin
  Int32VecConstant_70001_1,         // end
  Int32VecConstant_70000_1,     // strides
...
StridedSlice(model_17_tf_strided_slice_7_StridedSlice_70182,  // input data
  model_17_tf_strided_slice_11_StridedSlice_70184,      // output data
  Int32VecConstant_70006_0,       // begin
  Int32VecConstant_70004_1,         // end
  Int32VecConstant_70005_1,     // strides
  input_shape,    // input shape
  4,         // input dimensions
  output_shape,    // output shape
  4,   // output dimensions
...
StridedSlice(model_17_tf_strided_slice_7_StridedSlice_70182,  // input data
  model_17_tf_strided_slice_10_StridedSlice_70183,      // output data
  Int32VecConstant_70002_0,       // begin
  Int32VecConstant_70004_0,         // end
  Int32VecConstant_70005_0,     // strides
  input_shape,    // input shape
  4,         // input dimensions
  output_shape,    // output shape
  4,   // output dimensions
