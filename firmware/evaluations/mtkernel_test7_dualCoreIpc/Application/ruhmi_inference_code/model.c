...
int8_t* GetModelOutputPtr_Identity_70029() {
  return (int8_t*) (sub_0000_arena + sub_0000_address_Identity_70029);
}


void RunModel(bool clean_outputs) {
  // Buffers for NPU units
  int8_t* buf_Identity_70029 = (int8_t*) (sub_0000_arena + sub_0000_address_Identity_70029);
