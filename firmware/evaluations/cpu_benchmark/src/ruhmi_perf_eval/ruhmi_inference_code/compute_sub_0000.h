...
enum BufferSize_sub_0000 {
  ...
  kBufferSize_sub_0000 = 2833
#elif defined(ARM_MATH_DSP)
  kBufferSize_sub_0000 = 277
#else
  kBufferSize_sub_0000 = 277
#endif
...
void compute_sub_0000(
  ...
  uint8_t* main_storage, // should provide at least 277 bytes of storage

  // inputs
  
  const int8_t input_1[640], // 1,640
  

  // outputs
  
  int8_t Identity_70029[640]  // 1,640
