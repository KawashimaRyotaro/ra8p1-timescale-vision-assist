...
void compute_sub_0000(
  ...
  int8_t model_17_tf_strided_slice_8_StridedSlice_70185[37632] , // 1,112,112,3
  
  int8_t model_17_tf_strided_slice_9_StridedSlice_70186[37632]  // 1,112,112,3
  
) {
  // Buffers allocated on the main storage (note: depends on the execution order)
    
  
  int8_t* model_17_tf_strided_slice_6_StridedSlice_70181 = (int8_t *) &main_storage[0]; // 1,112,224,3 == 75264
  ...
  static const int32_t Int32VecConstant_70002_2[4] = { // 4
    0, 0, 0, 0, 
  };
...
StridedSlice(serving_default_images_0,  // input data
  model_17_tf_strided_slice_6_StridedSlice_70181,      // output data
...
StridedSlice(model_17_tf_strided_slice_6_StridedSlice_70181,  // input data
  model_17_tf_strided_slice_9_StridedSlice_70186,      // output data
...
StridedSlice(model_17_tf_strided_slice_6_StridedSlice_70181,  // input data
  model_17_tf_strided_slice_8_StridedSlice_70185,      // output data
  Int32VecConstant_70002_2,       // begin
